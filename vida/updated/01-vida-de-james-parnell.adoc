...
"`Una prueba de la Fe: donde se descubre el fundamento de la fe de los hipócritas,
que perece; y de la Fe de los Santos, fundada sobre la Roca Eterna;
para que todos vean cuál es su fe y en qué confían.`"
...
Amigos: A este don de Dios, en todas sus conciencias, le hablo,
...
Escrito desde el Castillo de Colchester, "`El 12 del primer mes, 1656.
